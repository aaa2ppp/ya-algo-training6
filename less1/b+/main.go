...
const infinity = int(2e9) + 1

func solve(mb, mr, nb, nr int) (int, int) {
	// bN, rN в этом количестве гарантировано есть нужный цвет
	// brN - гарантировано есть оба цвета
	var b1, r1, br1, b2, r2, br2 int
	...
	for _, v := range [][2]int{{b1, b2}, {r1, r2}, {br1, 1}, {1, br2}} {
		if v[0]+v[1] < m+n {
			m = v[0]
			n = v[1]
		}
