...
// solve возвращае кол-во вершин в каждом поддереве, с учетом, что корень это 1
// Функция ожидает, что граф не имеет циклов (по условию это деререво).
...
func run(in io.Reader, out io.Writer) {
	...
	writeInts(bw, res[1:], defaultWriteOpts())
}
